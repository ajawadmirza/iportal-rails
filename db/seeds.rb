...
candidate1 = Candidate.create(name: 'James Anderson', cv_url: 'https://d.novoresume.com/images/doc/minimalist-resume-template.png', cv_key: 'minimalist-resume-template.png', status: 'not interviewed', stack: 'MEAN', experience_years: '1',user: user1)
candidate2 = Candidate.create(name: 'Babar Azam', cv_url: 'https://resume-example.com/wp-content/uploads/2021/03/budapest-half.png', cv_key: 'budapest-half.png', status: 'interviewed by 2', stack: 'MEAN', experience_years: '2', user: user1)
candidate3 = Candidate.create(name: 'Stuart Broad', cv_url: 'https://cdn-images.zety.com/templates/zety/cascade-3-duo-blue-navy-21@3x.png', cv_key: 'cascade-3-duo-blue-navy-21@3x.png', status: 'interviewed by 3', stack: 'MERN', experience_years: '4', user: user3)
